# Source
The code is taken partly from https://github.com/devopsjourney1/argo-examples.git
Below is the original readme content.

I chanched the configmap by secrets which are defined via "sealed-secrets" (https://github.com/bitnami/sealed-secrets)

Note: The encrypted secrets here will only work on my test cluster.
